...
if (whiptail --title "AUTO-KALI STSRT"  --yesno '   mm            m                  #             ""#      "   \n   ##   m   m  mm#mm   mmm          #   m   mmm     #    mmm   \n  #  #  #   #    #    #" "#         # m"   "   #    #      #   \n  #mm#  #   #    #    #   #   """   #"#    m"""#    #      #   \n #    # "mm"#    "mm  "#m#"         #  "m  "mm"#    "mm  mm#mm\n\n                       是否安装Auto-kali?' 15 68) then
    exec apt-get install git python3 python3-termcolor -y
    exec git clone https://github.com/nios34/Auto-kali /usr/share/auto-kali
    exec ln -s /usr/share/auto-kali/START /bin/auto-kali
    exec chmod 777 /bin/auto-kali
